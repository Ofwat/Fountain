...
public interface CacheTestAuditDao extends AuditDao {

	public abstract void setAudit(Audit audit);
	public abstract Audit findById(int id);
	public abstract void delete(int id);
	public abstract void update(Audit audit);
	public abstract void setAll(List<Object> allCache);
