...
public interface CacheTestLockDao extends LockDao {

	public abstract void setUser(User user);
	public abstract void setLock(Lock lock);
	public abstract Lock findById(int id);
	public abstract void delete(int id);
	public abstract void update(Lock lock);
	public abstract void setAllLocks(List<Lock> locks);
