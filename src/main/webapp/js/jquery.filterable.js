  ...
  FilterableCell.prototype = {
    ...
    setMatch: function(match) {
      if(match){
        ...
        this.$cell.parent().css('display', 'table-row');
      } else {
        this.$cell.addClass('filterable-mismatch');
        this.$cell.parent().css('display', 'none');
  ...
  FilterableRow.prototype = {
    ...
    setMatch: function(match) {
      if(match){
        ...
        this.$row.css('display', 'table-row');
      } else {
...
(function($) {
  ...
  Filterable.prototype = {
    ...
    filter: function(query, cellIndex) {
      //Pre
      if(this.options.preFilterCallback != null){
    	  this.options.preFilterCallback(query);
      }    
      if($.fn.filterableutils.isNull(this.rows)){
        this.initRows();
      }
      ...
      //post
      if(this.options.postFilterCallback != null){
    	  this.options.postFilterCallback(query);
      }      
    },
  ...
  $.fn.filterable.defaults = {
    ...
    **/
    ...
    /**
    Custom callback after filter  
    **/
    preFilterCallback: null,
    
    /**
    Custom callback before filter  
    **/    
    postFilterCallback: null
