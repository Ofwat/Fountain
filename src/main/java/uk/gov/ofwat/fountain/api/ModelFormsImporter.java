...
public interface ModelFormsImporter {

	public abstract List<ModelPage> getFormPages();

	public abstract List<String> importModel(uk.gov.ofwat.model2.ModelDocument.Model incomingModel);
