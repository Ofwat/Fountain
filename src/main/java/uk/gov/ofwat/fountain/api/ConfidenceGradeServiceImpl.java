...
public class ConfidenceGradeServiceImpl implements ConfidenceGradeService {
	...
	public List<ConfidenceGrade> getConfidenceGrades() {
		return confidenceGradeDao.getAll();
	}
	...
	public ConfidenceGrade getConfidenceGrade(String code) {
		if (null == code ||
			...
			return confidenceGradeDao.findByCode(code);
		}
	}
	
	public ConfidenceGrade getConfidenceGrade(int id) {
		return confidenceGradeDao.findById(id);
	}
