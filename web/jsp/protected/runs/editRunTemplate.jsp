...
<head>
	...
	<title>Fountain: Edit Run Template</title>
...
<div class="container_12">
	<div>
		...
		<!-- Form Name -->
		<legend>Edit Run Template</legend>
		...
		<div id="selectExternalModels"></div>
					<table class="itemTable">
						<tr>
							<th>Models:</th><th></th><th>Selected Models</th><th></th>
						</tr>
						<tr>
							<td id="results">
		...
		<div class="control-group">
		  ...
		  <div class="controls">
		    ...
		    <a href="/Fountain/jsp/protected/runs/listRunTemplates.jsp" id="btnCancel" name="btnCancel" class="btn btn-default">Cancel</a>
		  </div>
		</div>
	...
	<script type="text/javascript">
		...
		dojo.addOnLoad(function(){
			...
			var xhr = $.get("/Fountain/rest-services/runs/templates/" + templateId, function(data){
				console.log(data);
			...
			$("#btnSave").click(function(){
				...
				$.ajax({
					...
					url:"/Fountain/rest-services/runs/templates/" + templateId + "/models", 
					contentType: "application/json; charset=utf-8",
					success:function(data){
						//ofwatDragSelect.getTargetNode().highlight('green');
						//Show a notification
						$.pnotify({
							title: 'Updated Run Template',
						    text: 'Successfully updated run template',
						    type: 'success',
						    opacity: .8,
						    history: false
						});							
					...
					error:function(jqXHR){
						...
						//Show a notification
						$.pnotify({
							 title: 'Could not update run template.',
							 text: 'Could not update run template: ' + error.responseText + '',
							 type: 'error',
							 opacity: .8,
							 history: false
						});							
			...
			getData("/Fountain/rest-services/model?typeId=5", "/Fountain/rest-services/runs/templates/" + templateId + "/models", test);			
