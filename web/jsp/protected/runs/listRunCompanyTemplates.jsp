...
<head>
	...
	<title>Fountain: List Company Sets</title>
...
<div>
	<div id="reports" class="grid_12">
		...
		-->
		<a class="btn" id="createRunCompanytemplate" href="createRunCompanyTemplate.jsp">Create A Company Set</a>
	...
	<script type="text/javascript">
		var deleteRunCompanyTemplate = function(runCompanyTemplateId){
			var _this = this;
			_this.runCompanyTemplateId = runCompanyTemplateId;
			var xhr = $.ajax({
				type:'DELETE',
				url:'/Fountain/rest-services/runs/companyTemplate/' + runCompanyTemplateId,
				success:function(data){
					$("#runCompanyTemplate_" + _this.runCompanyTemplateId).fadeOut("slow", function() {
						$("#runCompanyTemplate_" + _this.runCompanyTemplateId).remove();
					});
				}
			});
		};
		dojo.addOnLoad(function(){
			ofwat.loadTemplate(dojo.byId("tableData"), ofwat.template.runCompanyTemplateList);
		});	 
	</script>
