...
<head>
	...
	<title>Fountain: Create Company Set</title>
...
<div class="container_12">
	<div>
		...
		<div id="alert"></div>	
		<form class="form-horizontal" id="frmCreateRunCompanyTemplate">
		<fieldset>
		
		<!-- Form Name -->
		<legend>Create Company Set</legend>
		
		<!-- Text input-->
		<div class="control-group">
		  <label class="control-label" for="txtName">Name:</label>
		  <div class="controls">
		    <input id="txtName" name="txtName" type="text" placeholder="Company Set Name" class="input-large" required>
		...
		<div id="selectExternalCompanies"></div>
	...
	<script type="text/javascript">
		dojo.addOnLoad(function(){
			$("#btnCancel").click(function(){
				window.location.href = "/Fountain/jsp/protected/runs/listRunCompanyTemplates.jsp";
			});
			$("#frmCreateRunCompanyTemplate").submit(function(event){
				event.preventDefault();
				var runCompanyTemplateName = $("#txtName").val();
				var runCompanyTemplateDescription = $("#txtDescription").val(); //TODO Grab from form or passed to func.
				ofwat.runs.createRunCompanyTemplate(runCompanyTemplateName, runCompanyTemplateDescription, function(data){
